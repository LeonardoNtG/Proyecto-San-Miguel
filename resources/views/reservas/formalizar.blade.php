        ...
        <div class="card-body bg-light">
            ...
            <div class="row g-3 bg-white p-3 mb-3 rounded border shadow-sm">
                ...
                <div class="col-12 mb-2">
                    <label for="comentario" class="form-label font-weight-bold text-secondary">
                        <i class="fas fa-comment-dots text-primary me-1"></i> Comentarios / Observaciones <span class="text-muted fw-normal">(Opcional)</span>
                    </label>
                    <textarea class="form-control" id="comentario" name="comentario" rows="2" placeholder="Notas u observaciones sobre la formalización y pago inicial (opcional)">{{ old('comentario') }}</textarea>
                </div>
            </div>
